...
class SAFlightsApiTestCase(GraphQLTestCase):
    ...
    def test_airport_query(self):
        ...
        airport_content = json.loads(response.content)
        self.assertEqual(airport_content, {'data':{'airports':[{'name':'Cape Town International Airport','iataCode':'CPT', 'icaoCode':'FACT','imageUrl':'https://thumbs2.imgbox.com/6b/65/hln93WAv_t.jpeg'}]}}, 'Response has correct data')
